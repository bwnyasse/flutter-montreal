...
void main() {
  group('Movies App', () {
    ...
    // TODO 2- Explain the app content testing at runtime
    // TODO 3- Launch the cmd :  flutter drive --target=test_driver/app.dart
    test('starts with now playing movies', () async {
      // Movie 1
